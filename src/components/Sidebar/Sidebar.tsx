    ...
    <aside className="w-64 bg-zinc-900 text-white h-screen flex flex-col justify-between p-4 shadow-lg border-r border-zinc-800">
      ...
      <div className="mb-6">
        ...
        <div>
          ...
          >
            <span className="flex items-center gap-2"><SquareTerminal size={16} /> Overview</span>
          ...
          >
            <span className="flex items-center gap-2"><Bot size={16} /> Milestones</span>
          ...
          >
            <span className="flex items-center gap-2"><Settings2 size={16} /> Settings</span>
        ...
        <div className="mt-6  pt-4">
          ...
          <ul className="text-sm text-zinc-300 space-y-1">
            <li className="flex items-center gap-2"><Frame  size={14} /> Design System</li>
            <li className="flex items-center gap-2"><PieChart size={14} /> Legal</li>
            <li className="flex items-center gap-2"><Map size={14} /> Contact Us</li>
            <li className="flex items-center gap-2"><MoreHorizontal size={14} /> More</li>
          </ul>
        </div>
      </div>
