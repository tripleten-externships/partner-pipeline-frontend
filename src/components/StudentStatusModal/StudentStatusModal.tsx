...
type StudentStatus = "waiting" | "pending" | "approved" | "rejected" | "urgent";
    ...
    <div className="student-status__modal">
      <div className="student-status__modal_container">
        ...
        <form onSubmit={handleSubmit}>
          <div className="student-status__info">
            <div className="student-status__column">
              ...
              <p className="student-status__modal_program-text">
                {" "}
                {student.program}
              ...
              <button onClick={handleProfileLinkClick} className="student-status__profile-link">
                {" "}
                View Profile{" "}
              </button>
            </div>
          ...
          <input
            ...
            max="100"
            className="student-status__modal_notes"
          />
          <button type="submit" className="student-status__modal_save-button" disabled={isSaving}>
